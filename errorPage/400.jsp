...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() + "/StyleSheet/errorPageStyles/Style400.css"%>">
...
<body>
    ...
    <div class="error-container">
        <div class="error-content">
            ...
            <h1 class="error-title">Richiesta non valida</h1>
            <p class="error-description">
               Abbiamo ricevuto una richiesta in formato sconosciuto! <br>
               Forse è compatibile solo con cover di edizione limitata?.
            </p>
        ...
        <div class="image-container">
                <img src="<%= request.getContextPath() + "/images/errorPageMedia/Case400.png" %>" alt="Errore 400" class="error-image">
            </div>
