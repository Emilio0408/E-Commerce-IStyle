...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() + "/StyleSheet/errorPageStyles/Style500.css"%>">
...
<body>
    ...
    <div class="error-container">
        <div class="error-content">
            ...
            <h1 class="error-title">Errore interno del server</h1>
            <p class="error-description">
              Stiamo piazzando l’ultimo pezzo. <br>
                La tua cover perfetta arriverà a breve!
            </p>
        ...
        <div class="image-container">
            <img src="<%= request.getContextPath() + "/images/errorPageMedia/Case500.png" %>" alt="Errore 400" class="error-image">
        </div>
